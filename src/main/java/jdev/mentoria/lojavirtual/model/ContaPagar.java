...
public class ContaPagar implements Serializable {
	...
	@NotEmpty(message = "Descrição da Conta a Pagar não informada")
	@NotNull(message = "Descrição da Conta a Pagar não informada")
	@Column(nullable = false)
	private String descricao;
	
	@NotNull(message = "Valor Total da Conta a Pagar não informado")
	@Column(nullable = false)
	private BigDecimal valorTotal;
	
	private BigDecimal valorDesconto;
	
	@NotNull(message = "Data de Vencimento da Conta a Pagar não informado")
	@Column(nullable = false)
	...
	@NotNull(message = "Status da Conta a Pagar não informado")
