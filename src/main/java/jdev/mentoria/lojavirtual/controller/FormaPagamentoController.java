...
public class FormaPagamentoController {
	...
	@PostMapping(value = "**/salvarFormaPagamento")  /*Mapeando a url para receber o JSON*/
	public ResponseEntity<FormaPagamento> salvarFormaPagamento(@RequestBody @Valid FormaPagamento formapagamento) throws ExceptionMentoriaJava { /*Recebe o JSON e converte para Objeto*/
