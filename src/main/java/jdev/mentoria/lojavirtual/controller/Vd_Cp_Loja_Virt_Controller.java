...
public class Vd_Cp_Loja_Virt_Controller {
	...
	public ResponseEntity<List<VendaCompraLojaVirtualDTO>> 
	                    consultaVendaDinamicaFaixaData(@PathVariable("data1") String data1,
...
//		Date d2 = dateFormat.parse(data2);
	...
	public ResponseEntity<List<VendaCompraLojaVirtualDTO>> consultaVendaPorCliente(@PathVariable("idCliente") Long idCliente) {
		...
		List<VendaCompraLojaVirtual> compraLojaVirtual = vd_Cp_Loja_virt_repository.vendaPorProduto(idCliente);
